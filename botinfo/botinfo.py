...
class BotInfo:
    ...
    def join_message(self):
        ret = bold("Hey there!") + "\n"
        ret += "I'm MicroCreeper and I just got asked to join this server.\n"
        ...
        ret += "\n\n"
        ret += italics("If you want support:") + " "
        ret += inline("*contact [desc]")
        ret += " and it will be sent to my owner.\n"
        ret += "If you need the commands? Type " + inline(self.prefixes * "help")
        return ret
    ...
    async def info(self):
        ...
        await self.bot.say("I'm MicroCreeper, a general, multi-purpose bot that is"
    ...
    async def invite(self):
        ...
        await self.bot.say("You must have manage server permissions in order"
                           ...
                           "client_id=242265456629514240&scope=bot&"
